...
<%
	...
	int resCode = new DaoUtils().insertMatchType(new MatchType(enrolltimed, uploadtimed, new Date(), matchname, matchinfo));
	if(resCode == 0)
	{
		response.sendRedirect("./adminerror.jsp?error=" + java.net.URLEncoder.encode("发布错误！", "UTF-8"));
		return;
	}
	else
	{
		response.sendRedirect("./adminsuccess.jsp?success=" + java.net.URLEncoder.encode("发布成功！", "UTF-8"));
	}
